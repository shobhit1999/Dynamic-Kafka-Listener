...
import static com.dynamic.kafkalistener.enumeration.DynamicKafkaListenerType.CONSUMER_2;

@Slf4j
@Component
public class Consumer2 extends DynamicKafkaListener {

  @Override
  public void consumePayload(String payload, Headers headers, Acknowledgment acknowledgment) {
    log.info("Consuming callback for consumer 2 {}, headers {}", payload, headers);
